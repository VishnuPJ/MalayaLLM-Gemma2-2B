...
wandb.init(project="Gemma_2_2B_MalayaLLM", name = "Pretrain")
...
# trainer_stats = trainer.train("checkpoint-10723")
wandb.finish()
model.save_pretrained_merged("Merged_Gemma_2_2B_MalayaLLM_Pretrain", tokenizer, save_method = "merged_16bit",)
